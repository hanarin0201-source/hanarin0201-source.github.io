...
function load26(){load('/mobile-compose-v26.js?v=26')}
async function allowArchive(){
 ...
 }catch(e){location.replace('/?v=26&archiveDenied=1');return false}
}
const archiveMode=['20','21','22','23','24','25'].some(v=>path.startsWith('/versions/v'+v+'/'))||['20','21','22','23','24','25'].includes(archived);
...
load20(()=>load21(()=>load22(()=>load23(()=>load24(()=>load25(()=>load26()))))));
})();
